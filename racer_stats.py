...
with right_column_1:
    ...
    df_best = df_best[['Character','Win Percent']].sort_values('Win Percent',ascending=False).iloc[0:x] #iloc chooses number of "rows" from slider .loc would denote columns
